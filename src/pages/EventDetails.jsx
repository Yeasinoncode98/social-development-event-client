...
//   // ✅ New function: Delete joined event
//   const handleDeleteJoined = async () => {
//     if (!user?.email || !event) return;
//     try {
//       // Remove current user from joinedUsers
//       setEvent((prev) => ({
//         ...prev,
//         joinedUsers: prev.joinedUsers.filter((email) => email !== user.email),
//       }));

//       // Show success toast
//       toast.success(`Deleted ${event.title || "Event"}`);
//     } catch (error) {
//       toast.error("Failed to delete joined event.");
//       console.error(error);
//     }
//   };
...
//             {/* ✅ New Delete Joined Event button */}
//             <button
