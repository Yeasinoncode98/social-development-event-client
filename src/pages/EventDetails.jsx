...
//         <div className="text-center p-8 backdrop-blur-xl bg-white/30 dark:bg-gray-900/30 rounded-3xl border border-white/20">
//           <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100">
//             Event not found
//           </h2>
//           <button
//             onClick={() => navigate("/")}
//             className="mt-4 px-6 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full hover:shadow-lg transition-all"
//           >
//             Go Back Home
//           </button>
//         </div>
...
//       <div
//         className="absolute -inset-0.5 bg-gradient-to-r opacity-0 group-hover:opacity-100 blur transition duration-300 rounded-2xl"
//         style={{ background: gradient }}
//       ></div>
//       <div className="relative flex items-center gap-4 p-4 rounded-2xl backdrop-blur-xl bg-white/60 dark:bg-gray-800/60 border border-white/20 dark:border-gray-700/20 hover:scale-105 transition-all duration-300">
//         <div
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 dark:from-gray-900 dark:via-purple-900/10 dark:to-gray-900 py-8 px-4">
//       {/* Animated background orbs */}
//       <div className="fixed top-0 left-0 w-96 h-96 bg-purple-300/30 dark:bg-purple-600/20 rounded-full blur-3xl animate-pulse"></div>
//       <div className="fixed bottom-0 right-0 w-96 h-96 bg-pink-300/30 dark:bg-pink-600/20 rounded-full blur-3xl animate-pulse delay-1000"></div>

//       <div className="max-w-6xl mx-auto relative">
//         {/* Back Button */}
//         <button
//           onClick={() => navigate(-1)}
//           className="mb-6 flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-xl bg-white/60 dark:bg-gray-800/60 border border-white/20 hover:scale-105 transition-all shadow-lg"
//         >
...
//           <div className="relative backdrop-blur-2xl bg-white/40 dark:bg-gray-900/40 rounded-3xl border border-white/20 dark:border-gray-700/20 shadow-2xl overflow-hidden">
//             {/* Hero Image Section */}
...
//                 <div className="flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-xl bg-white/20 border border-white/30 shadow-2xl">
...
//               {/* Share Button */}
//               <button className="absolute top-6 right-6 z-30 p-3 rounded-full backdrop-blur-xl bg-white/20 border border-white/30 hover:bg-white/30 transition-all shadow-lg">
...
//                 <div className="relative p-6 rounded-2xl backdrop-blur-xl bg-white/50 dark:bg-gray-800/50 border border-white/20">
...
//                     <div className="relative flex items-center justify-center gap-3 px-8 py-4 rounded-2xl bg-white dark:bg-gray-900 group-hover/btn:bg-transparent transition-all">
//                       {hasJoined ? (
//                         <>
...
//                       ) : (
//                         <>
//                           <Sparkles className="w-5 h-5 text-purple-600 group-hover/btn:text-white" />
//                           <span className="font-bold text-gray-800 dark:text-gray-100 group-hover/btn:text-white">
...
//                     className="flex-1 flex items-center justify-center gap-3 px-8 py-4 rounded-2xl backdrop-blur-xl bg-gradient-to-r from-blue-500/80 to-indigo-500/80 hover:from-blue-600 hover:to-indigo-600 text-white font-bold shadow-lg hover:shadow-xl transition-all hover:scale-105"
//                   >
//                     <Users className="w-5 h-5" />
//                     View My Events
//                   </button>
...
//               {!user && (
//                 <div className="p-6 rounded-2xl backdrop-blur-xl bg-gradient-to-r from-red-500/10 to-pink-500/10 border border-red-500/20">
