...
//       console.log("🔍 Fetching joined events for:", user.email);

//       try {
//         const data = await getJoinedEvents(user.email);
//         console.log("📋 Joined events:", data);
//         setEvents(data);
//       } catch (error) {
...
//                   className="mt-3 w-full bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 transition"
//                 >
//                   Delete Joined Event
//                 </button>
//               </div>
