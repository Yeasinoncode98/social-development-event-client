// // Rrefresh and toast issue 3 gemini
...
//       thumbnail,
//       location,
//       // Date is converted to ISO string before sending
...
//       {/* ✅ FIX: Using Toaster with recommended positioning and removing custom fixed wrapper */}
//       {/* <Toaster
//         position="top-center"
//         toastOptions={{
//           style: {
...
//             padding: "12px 20px",
//             fontSize: "15px",
//             // Removed custom marginTop that interferes with position="top-center"
//           },
//           success: {
...
//   return (
//     <div className="relative max-w-3xl mx-auto p-6 mt-10 bg-white dark:bg-gray-800 shadow-md rounded-lg">
//       {/* 🚀 FIX: The single Toaster component is correctly placed and configured here */}
//       {/* <Toaster
//         position="top-center"
//         toastOptions={{
//           style: {
...
//   return (
//     <div className="relative max-w-3xl mx-auto p-6 mt-10 bg-white dark:bg-gray-800 shadow-md rounded-lg">
//       {/* The single Toaster component is correctly placed here */}
//       <Toaster
//         position="top-center"
//         toastOptions={{
//           style: {
