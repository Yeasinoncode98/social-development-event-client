...
//   useEffect(() => {
//     fetch("/visitus.json") // fetch from public folder
//       .then((res) => res.json())
//       .then((data) => {
//         setImages(data);
//         setLoading(false);
...
//             <div className="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-lg transform hover:scale-105 transition duration-300">
//               <img
//                 src={item.image}
//                 alt={item.title}
//                 className="w-full h-48 object-cover"
